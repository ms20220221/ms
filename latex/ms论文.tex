...
\begin{figure}[!hb]
  \centering 
  \includegraphics[height=2.85in]{D:/meisai/ms/fig/fig3G.eps}
  \includegraphics[height=2.85in]{D:/meisai/ms/fig/fig3b.eps}
...
\subsubsection{Determining the parameters p, q from the autocorrelation and partial autocorrelation plots}
